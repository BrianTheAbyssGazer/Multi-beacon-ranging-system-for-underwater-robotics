...
class PingOut {
    ...
    public:
        ...
        static volatile int first_impulse_pfx; // starting pfx of multiple impulses scheduling
        static volatile int last_impulse_pfx; //ending pfx of multiple impulses scheduling
    private:
