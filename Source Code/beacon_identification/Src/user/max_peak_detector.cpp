...
void MaxPeakDetector :: send_data2computer(Timestamp first_peak_tmsp, uint16_t consecutive_pulses_detected) {
    (*p_index_info_tx).transmit_idx(first_peak_tmsp.idx, first_peak_tmsp.pfx, consecutive_pulses_detected);
}
