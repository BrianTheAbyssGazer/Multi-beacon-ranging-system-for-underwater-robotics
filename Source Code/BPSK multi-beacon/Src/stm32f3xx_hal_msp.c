...
void HAL_ADC_MspInit(ADC_HandleTypeDef* hadc)
{
  ...
  if(hadc->Instance==ADC1)
  {
    ...
    PA2     ------> ADC1_IN3
    */
    GPIO_InitStruct.Pin = Thermister_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(Thermister_GPIO_Port, &GPIO_InitStruct);
...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* hadc)
{
  if(hadc->Instance==ADC1)
  {
    ...
    PA2     ------> ADC1_IN3
    */
    HAL_GPIO_DeInit(Thermister_GPIO_Port, Thermister_Pin);
  ...
  else if(hadc->Instance==ADC2)
  {
    ...
    PC2     ------> ADC2_IN8
    */
    HAL_GPIO_DeInit(Battery_Sense_In_GPIO_Port, Battery_Sense_In_Pin);
  ...
  else if(hadc->Instance==ADC4)
  {
    ...
    PB15     ------> ADC4_IN5
    */
    HAL_GPIO_DeInit(Rcv_Siganl_In_GPIO_Port, Rcv_Siganl_In_Pin);
